...
function viewPDF(id, src, text) {
    if (!isMobile()) {
        $(id).append(`<embed src="` + src + `" width="100%" height="500">`);
    } else {
        $(id).append(
            `<div class="_download">
                <a href="` +
                ...
                `" class="">
                    <div uk-grid>
                        <p class="_undecorate _text _blue _one_line uk-width-4-5">
                            ` +
                text +
                `
                        </p>
                        <p class="uk-width-1-5">
                            <span uk-icon="icon: download; ratio: 2.5" class=" _text _blue"></span>
                        </p>
                    </div>
                </a>
            </div>`
