...
<div id="main">
		<form id="formRegistra" action="iniciarSesion2.php" method="post" onsubmit="return valida();">
		<center>
						<span style="font-size:40;">Iniciar Sesion PNPC</span>
						<br></br>
						<table style="font-size:20;">
								...
								<input id="Usuario" type="text" class="campo" name="Usu" placeholder=""/></td>
								<td><div id="errorUsuario" class="error"><p></p></div></td>
			</tr>
			<tr>
				<td><label><FONT COLOR="#b8b8b8">Password:</FONT></label></td>
				
				<td><input id="password" type="password" class="campo" name="Pass" placeholder=""/></td>
