      ...
      <div class="col s12 m10 offset-m1 l6 offset-l3">
        <div class="card hoverable">
            <div class="card-image valign-wrapper">
                <img src="images/boton-becas.jpg">
            </div>
        <div class="card-stacked">
            ...
            <spam>
                <table class="highlight">
                    ...
                    <tbody>
                      <tr>
                        <td>Actualización para Docentes</td>
                        <td>Apoyo para estudios de Posgrados de Alta Calidad PRODEP</td>
                        <td><a href="http://www.dgesu.ses.sep.gob.mx/Documentos/DSA%20gobmx/PDF/Apoyos%20para%20estudios%20de%20posgrado%20de%20alta%20calidad.pdf">Consulta la Convocatoria</a></td>
                      </tr>
                      <tr>
                        <td>Estudiantes</td>
                        <td>Programa Nacional de Becas SEP. Beca para Estudios de Especialidad, Maestría, Doctorado y Estancias Posdoctorales</td>
                        <td><a href="http://www.becaseducacionsuperior.sep.gob.mx/2-principal/206-beca-para-estudios-de-especialidad,-maestr%C3%ADa,-doctorado-y-estancias-posdoctorales">Consulta la Convocatoria</a></td>
                      </tr>
                      <tr>
                        <td>Estudiantes</td>
                        <td>Becas - Crédito otorgadas por El Fondo para el Desarrollo de Recursos Humanos (FIDERH) - Banco de México</td>
                        <td><a href="http://www.fiderh.org.mx/index.html">Consulta la Convocatoria</a></td>
                      </tr>
                    </tbody>
                 </table>
            </spam>
