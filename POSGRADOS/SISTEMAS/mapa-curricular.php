...
<div class="cabecera">
  ...
  <div class="row">
    <div class="col s12 m8 l8" id="reticula">
      <div class="card">
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4 flow-text">Mapa Curricular<i class="material-icons right">more_vert</i></span>
          <img src="images/reticula/reticula-msc.jpg" class="materialboxed responsive-img">
        </div>
      </div>
    </div>
    ...
    <div class="col s12 m6 l4">
      <div class="card">
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4 flow-text">LGAC en Seguridad Informática<i class="material-icons right">more_vert</i></span>
          <img src="images/reticula/msc-seg-inf.jpg" class="materialboxed responsive-img">
        </div>
      </div>
    </div>
    <div class="col s12 m6 l4">
      <div class="card">
        <div class="card-content">
          <span class="card-title activator grey-text text-darken-4">LGAC en Ingeniería de Software y Sistemas Distribuidos<i class="material-icons right">more_vert</i></span>
          <img src="images/reticula/msc-ing-sw.jpg" class="materialboxed responsive-img">
        </div>
      </div>
    </div>
  </div>
