      ...
      <div class="col s12 m12 l10 offset-l1">
        <div class="card horizontal">
            <div class="card-image valign-wrapper">
                <img src="images/lgac.jpg" width="100px">
            </div>
        <div class="card-stacked">
            <div class="card-content">
            <spam><p>
                Nuestro programa de posgrado contribuye y apoya al conocimiento en dos áreas primordiales. Estas fomentan técnicas y métodos de investigación en las líneas de “Seguridad Informática” e “Ingeniería de Software y Sistemas Distribuidos”, ofrece a los diferentes sectores de las Tecnologías de Información (TI) conocimientos de vanguardia, experiencias y programas de educación. Apoyando con esto a las grandes, medianas y pequeñas empresas, mediante la formación de profesionistas de alta calidad y competentes en: proyectos de investigación, vinculación con la industria, ciencia aplicada entre otras. </p>

                <p>En la <B>línea de Seguridad Informática</B> se promueve un uso efectivo, seguro y confiable de las TI. Acorde con las  necesidades y exigencias de los diversos sectores empresariales, nacionales e internacionales apegados a estándares.</p>
 
                <p> En la <B>línea de Ingeniería de Software y Sistemas Distribuidos</B> se desarrollan e implementan métodos, herramientas y técnicas cuya finalidad es producir software de calidad en un ambiente cliente servidor y sistemas distribuidos, usando TI de vanguardia. </p>

                <p>En ambas áreas del conocimiento se fomenta la formación de líderes nacionales y pioneros mundiales en la investigación aplicada, innovación y desarrollo tecnológico, utilizando métodos, procesos, técnicas y herramientas de alta Ingeniería y uso aplicado de la ciencia.
            </p></spam>
            </div>
