...
<head>
  ...
  <title>Maestría en Sistemas Computacionales - Resultados del Proceso de Admisión 2018</title>
    ...
    <div class="col s12 m8 l8 offset-l2">
      <div class="card blue-grey darken-1">
        <div class="card-content white-text">
          <span class="card-title center">Alumnos Aceptados, Generación 2018</span>
            <ol>
              <li>Figueroa Aguilar Jaime</li>
              <li>Flores Zarco Sergio Vladimir</li>
              <li>Guzmán Pérez Claudia Vanessa</li>
              <li>Hernández Navarro Geovanni</li>
              <li>Morales Hernández Guadalupe Yeraldin</li>
              <li>Pacheco Pimentel Efrén de Jesús</li>
              <li>Paniagua Villagómez Omar</li>
              <li>Pérez Rosales Alfred Jonathan</li>
              <li>Punzo Boyzo José Antonio</li>
              <li>Rafael Soto Landa</li>
              <li>Reyes Gutiérrez Mauricio René</li>
              <li>Ruíz Lagunas Juan Jesús</li>
              <li>Ruíz Martínez Luis Enrique</li>
              <li>Salmerón Ayala Paris Jorge</li>
              <li>Solache Hernández Luis Antonio</li>
              <li>Villaseñor Mauleón José Guadalupe</li>
            </ol>
            <br>
            <p>A partir del próximo Lunes 6 de Agosto, en horario de 8am a 12pm se estarán entregando las cartas de aceptación de cada aspirante.</p><br>
