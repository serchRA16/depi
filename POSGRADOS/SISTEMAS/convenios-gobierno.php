...
<div class="cabecera">
 ...
 <div class="row">
  <div class="col s12 m8 offset-m2 l6 offset-l3 hide-on-small-only">
    <div class="card hoverable horizontal">
      <div class="card-image valign-wrapper">
          <img src="images/convenio-icon.png">
      </div>
      <div class="card-stacked">
          <div class="card-content">
          <spam>Si trabajas en el gobierno federal, estatal o municipal y tienes necesidades en las áreas de seguridad informática o desarrollo de software especializado, acércate a nosotros, podemos establecer un convenio de colaboración y hacer esos proyectos una realidad en beneficio de la sociedad michoacana y mexicana.</spam>
          </div>
          
      </div>
    </div>
  </div>
  <div class="col s12 m8 offset-m2 l6 offset-l3 hide-on-med-and-up">
    ...
    <div class="col s6 m4 l3">
      <div class="card">
        <div class="card-image">
          <img src="images/1200px-Escudo-UNAM.png">
        </div>
        <div class="card-content">
          <p>Convenio de Colaboración ITM-UNAM Morelia</p>
        </div>
      </div>
    </div>
  </div>
