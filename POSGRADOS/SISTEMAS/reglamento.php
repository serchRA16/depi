      ...
      <div class="col s12 m6 offset-m3 l6 offset-l3">
        <div class="card ">
            <div class="card-image valign-wrapper">
                <img src="images/boton-reglamento.jpg">
            </div>
        <div class="card-stacked">
            <div class="card-content">
            <spam>Docuemento de Lineamientos Académicos vigente para Estudios de Posgrado en el TecNM.</spam>
            </div>
        <div class="card-action">
              <a href="http://www.tecnm.mx/images/areas/posgrado01/Lineamientos_Posgrado_2013.pdf"><i class="material-icons left">cloud_download</i>Leer el documento original.</a>
        </div>
